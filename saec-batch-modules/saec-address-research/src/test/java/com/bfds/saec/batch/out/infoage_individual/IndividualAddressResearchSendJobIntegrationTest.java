...
public class IndividualAddressResearchSendJobIntegrationTest extends AddressResearchSendJobIntegrationTest {
    ...
    protected JobParameters getJobParameters() {
        return new JobParametersBuilder().addString("dda", "11111111").addString("accountType", AccountType.INDIVIDUAL).addString("researchType", ResearchType.RESEARCH).toJobParameters();
    }
                ...
                new Object[][]
                        {
                                ...
                                {"firstName", "first name-1", "first name-1", "first name-1"},
                                {"middleName", "middle name-1", "middle name-1", "middle name-1"},
                                {"inputRecord", "", "", ""},
                                {"ssn", "11-22-33", "11-22-33", "11-22-33"},
