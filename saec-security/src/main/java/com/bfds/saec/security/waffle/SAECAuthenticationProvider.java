 ...
 * from SAEC Db
 */
public class SAECAuthenticationProvider extends WindowsAuthenticationProvider {

    Logger logger = LoggerFactory.getLogger(SAECAuthenticationProvider.class);
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            SAECAuthenticationToken token = new SAECAuthenticationToken(windowsPrincipal);
