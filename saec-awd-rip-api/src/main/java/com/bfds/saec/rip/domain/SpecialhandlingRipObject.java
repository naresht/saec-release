...
@RooJpaActiveRecord(persistenceUnit="entityManagerFactory", table="awd_rip_special_handling")
@RooJavaBean
@RooConfigurable
@RooToString
public class SpecialhandlingRipObject extends RipObject {
	...
	public boolean equals(Object obj) {
		...
		SpecialhandlingRipObject other = (SpecialhandlingRipObject) obj;
		if (address1 == null) {
