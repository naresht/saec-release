...
@Repository
public class DefaultAwdRpoJobConfigRepositoryInitializer implements ApplicationContextAware {
	...
	public void initialize() throws IOException, NoSuchColumnException,
		...
		JobConfig jc = JobConfigFactory.newJobConfig("awdRpoUploadJob", "AWD RPO Upload", true);
		jc.setVendorName("AWD");
		jc.getScheduleConfig().setCronExpression("0 0/1 * 1/1 * ? *");
		jc.persist();
