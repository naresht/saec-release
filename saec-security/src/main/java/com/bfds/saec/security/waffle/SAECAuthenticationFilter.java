 ...
 */
public class SAECAuthenticationFilter extends NegotiateSecurityFilter {

    Logger logger = LoggerFactory.getLogger(SAECAuthenticationFilter.class);
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (!authorizationHeader.isNull()
            ...
            try {
                ...
                SAECAuthenticationToken authentication = new SAECAuthenticationToken(principal);
