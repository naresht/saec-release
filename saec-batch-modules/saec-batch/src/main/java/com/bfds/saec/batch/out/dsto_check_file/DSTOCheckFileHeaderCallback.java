...
public class DSTOCheckFileHeaderCallback implements FlatFileHeaderCallback,
	...
	private String recordType = ConverterUtils
			.getFormattedString1("010", 3, " ");
	...
	public void writeHeader(Writer writer) throws IOException {
		String BankName = (String) stepExecution.getExecutionContext().get(
				"bankName");
