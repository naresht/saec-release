package com.bfds.saec.batch.out.ss_issue_void;
 ...
 */
public abstract class SSOutputBatchServiceImpl implements OutputBatchService {

	final Logger log = LoggerFactory.getLogger(SSOutputBatchServiceImpl.class);
